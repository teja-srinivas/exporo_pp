...
{
    public const PERMISSION = 'management.bills';

    public const CAN_BE_BILLED_PERMISSION = 'features.bills.receive';

    public const DOWNLOAD_PERMISSION = 'features.bills.download';
