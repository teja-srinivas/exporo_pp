...
return [
    ...
    | in /database/snapshots. If you would like to
    | change the location of the files, update the paths below.
    */
    'snapshot-location'  => base_path('database/snapshots/').'snipe_snapshot.sql',
    'snipefile-location' => base_path('database/snapshots/').'.snipe',
